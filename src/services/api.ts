...
export const API_AUTH_URL = 'http://localhost:8000/api/v1/auth/'
export const API_THREAD_URL =  'http://localhost:8000/api/v1/threads/'
export const API_COMMUNITY_URL = 'http://localhost:8000/api/v1/communities/'
export const API_NOTIFICATION_URL = 'http://localhost:8000/api/v1/notifications/'
export const API_LOCAL_BASE_URL =  'http://localhost:8000/api/v1/'
